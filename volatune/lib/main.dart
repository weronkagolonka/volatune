...
//               ],
//             ),
//             body: _connected ? _displayPlayedSong(context) : Center(child: Text('no playback')),
...
//   // image, title, artist, album?
//   // show if it's playing, if it's paused, do not show anything

//   Widget _displayPlayedSong(BuildContext context) {
//     return (
